...
public class TopTallHedronCornerBase extends FancyHedronModel {
    public TopTallHedronCornerBase(SpriteIdentifier texture) {
        super(texture);
    }

    public TopTallHedronCornerBase(SpriteIdentifier face, SpriteIdentifier inner, SpriteIdentifier base) {
