...
public class TopTallHedronPoint extends FancyHedronModel {
    public TopTallHedronPoint(SpriteIdentifier texture) {
        super(texture);
    }

    public TopTallHedronPoint(SpriteIdentifier face, SpriteIdentifier inner, SpriteIdentifier base) {
