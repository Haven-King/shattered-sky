...
public class TopTallHedronSlopeTip extends FancyHedronModel {
    public TopTallHedronSlopeTip(SpriteIdentifier texture) {
        super(texture);
    }

    public TopTallHedronSlopeTip(SpriteIdentifier face, SpriteIdentifier inner, SpriteIdentifier base) {
