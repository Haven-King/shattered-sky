...
public class BottomHedronPoint extends FancyHedronModel {
    public BottomHedronPoint(SpriteIdentifier texture) {
        super(texture);
    }

    public BottomHedronPoint(SpriteIdentifier face, SpriteIdentifier inner, SpriteIdentifier base) {
